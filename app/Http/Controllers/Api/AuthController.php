...
use App\Http\Requests\Api\Auth\UpdateDeviceDataRequest;
...
class AuthController extends Controller {
    ...
    public function register(RegisterRequest $request) {
        ...
        $user->refresh();
        return $this->response('success', __('apis.registered'), $user->login());
    }

    public function registerProvider(RegisterProviderRequest $request) {
        $provider = Provider::create($request->validated());
        $provider->sendVerificationCode();
        $userData = new ProviderResource($provider->refresh());
    ...
    public function updateDeviceData(UpdateDeviceDataRequest $request) {
        $user = auth()->user();
