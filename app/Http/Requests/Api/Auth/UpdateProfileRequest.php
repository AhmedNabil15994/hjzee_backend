...
class UpdateProfileRequest extends BaseApiRequest {
  ...
  public function rules() {
    return [
      'country_code' => 'sometimes|nullable|numeric|digits_between:2,5',
      'phone'        => 'sometimes|nullable|numeric|digits_between:7,9|unique:users,phone,'.auth()->id().',id,deleted_at,NULL',
