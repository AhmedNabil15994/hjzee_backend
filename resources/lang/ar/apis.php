...
return [
  ...
  'coupon_start_at'        => 'الكوبون يبدأ استخدامة من تاريخ :date',
  ...
  'activeCode'     => 'كود التفعيل الخاص بك هو : ',
  'rating_success'  => 'تم التقييم بنجاح',
  'pay_success'  => 'تم الدفع بنجاح',
  'not_available_payment_method'  => 'وسيلة الدفع هذه غير متوفرة حالياً',
  'no_available_seats'  => 'عذراً لم يعد هناك مقاعد متاحة',
  'available_seats'     => 'عذراً المقاعد المتاحة فقط :num_seats',
  
  'type_ads'          => 'اعلانات' ,
  'type_services'     => 'خدمات' ,
  'type_places'       => 'مراكز' ,
  'type_categories'   => 'اقسام' ,
  'type_description'  => 'وصف' ,
  'payment_failed'    => 'عذراً لقد فشلت عملية الدفع',
  'payment_success'  => 'تمت عملية الدفع بنجاح',
  'already_paid'  => 'هذا الحجز مدفوع بالفعل',
  'provider_not_active_now' => 'هذا الحساب غير مفعل في الوقت الحالي',
];
