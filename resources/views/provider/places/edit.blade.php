    ...
    <div class="page-contant mt-5 mb-5 pr-2 pl-2">
        <div class="container fadedown1">
            <div class="title mt-5 mb-4">
                <h5 class="mb-0">{{__('provider.edit_place')}}</h5>
            </div>
            ...
            @endif
            <form  method="POST" action="{{route('provider.updatePlace' , [$place])}}" class="store form-horizontal" id="form">
                @csrf
                @method('PUT')
                <div class="form-body">
                    <div class="row">
...
<script>
    $(document).on('click', '.delete-image', function(e) {
        ...
        var url = '{{ route('provider.deletePlaceImage') }}';
