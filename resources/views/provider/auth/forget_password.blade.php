...
<head>
    ...
    <title>{{__('auth.forgetPass')}}</title>
</head>
<body>
    <div class="loader">
...
<section class="logo-content pt-5 mb-5 fadedown2">
    <div class="container">
        ...
        @endif
        <form class="log-form row" action="{{route('provider.password.email')}}" method="POST" id="form">
        @csrf
            ...
            <button class="add-btn" type="submit">{{__('auth.send')}}</button>
        </form>
    </div>
</section>
