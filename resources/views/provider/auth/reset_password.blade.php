...
<section class="logo-content pt-5 mb-5 fadedown2">
    <div class="container">
        ...
        <form class="log-form row" action="{{route('provider.password.createReset')}}" method="POST" id="form">
            @csrf
            ...
            <div class="form_label col-12">
                ...
                <label class="float_label"> {{__('auth.code')}}</label>
            </div>
            <div class="form_label col-12">
            ...
            <button class="add-btn" type="submit">{{__('auth.save')}}</button>
        </form>
