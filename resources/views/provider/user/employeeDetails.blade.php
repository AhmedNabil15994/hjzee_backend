    ...
    <div class="page-contant mt-5 mb-5 pr-2 pl-2">
        <div class="container fadedown1">
            <div class="title mt-5 mb-4">
                <h5 class="mb-0">{{__('provider.employee_details')}}</h5>
            </div>
...
@endif
            <form class="row" action="{{route('provider.deleteEmployee',[$employee])}}" method="POST"  enctype="multipart/form-data" id="form">
                @csrf
                @method('Delete')
                            ...
                            <div class="textCenter">
                                <div class="imagesUploadBlock">
                                    ...
                                    <div class="uploadedBlock">
                                        <a href="{{$employee->image}}" target="blank"><img src="{{$employee->image}}"></a>
