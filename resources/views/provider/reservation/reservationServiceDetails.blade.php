                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="number" name="quantity" value="{{ $order->quantity }}" step="1" min="0" class="form-control" placeholder="{{__('admin.quantity')}}" disabled>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach($order->names as $name)
                                    <div class="col-md-12 col-6">
                                        <div class="form-group">
                                            <label for="first-name-column">{{__('admin.name')}}</label>
                                            <div class="controls">
                                                <input type="text"  name="users_names[]" value="{{ $name->name }}" class="form-control" placeholder="{{__('admin.name')}}"  disabled>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
