...
@endif
            <form class="row" action="{{route('provider.updateServiceReservation',[$order])}}" method="POST"  enctype="multipart/form-data" id="form">
                @csrf
                @method('PUT')
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="number" name="quantity" value="{{ $order->quantity }}" step="1" min="0" class="form-control" placeholder="{{__('admin.quantity')}}" >
                                </div>
                            </div>
                        </div>
