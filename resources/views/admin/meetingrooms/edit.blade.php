...
<form action="{{route('admin.meetingrooms.update',['id' => $meetingroom->id])}}" method="post" enctype="multipart/form-data" class="store form-horizontal" novalidate>
    @method('PUT')
    @csrf
                                ...
                                <div role="tabpanel" class="tab-pane" id="account-vertical-times" aria-labelledby="account-pill-times" aria-expanded="false">
                                    <div class="row">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                @include('admin.meetingrooms.edit_day',['day' => 'Saturday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Sunday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Monday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Tuesday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Wednesday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Thursday'])
                                                @include('admin.meetingrooms.edit_day',['day' => 'Friday'])
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
...
<script>
    $(document).on('click', '.delete-image', function(e) {
        ...
        var url = '{{ route('admin.meetingrooms.delete.image') }}';
