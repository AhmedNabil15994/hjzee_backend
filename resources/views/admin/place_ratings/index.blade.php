...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    {{-- addbutton="{{ route('admin.place-ratings.create') }}"  --}}
    deletebutton="{{ route('admin.place-ratings.deleteAll') }}" 
    :searchArray="[
        'meeting_room_id' => [
            'input_type' => 'select' , 
            'rows'       => $rooms , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/place-ratings')])
@endsection
