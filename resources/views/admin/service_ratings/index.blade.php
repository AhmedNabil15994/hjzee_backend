...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    {{-- addbutton="{{ route('admin.service-ratings.create') }}"  --}}
    deletebutton="{{ route('admin.service-ratings.deleteAll') }}" 
    :searchArray="[
        'service_id' => [
            'input_type' => 'select' , 
            'rows'       => $services , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/service-ratings')])
@endsection
