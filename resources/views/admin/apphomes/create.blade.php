                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade @if($loop->first) show active @endif " id="first_{{$lang}}" aria-labelledby="first_{{$lang}}" aria-expanded="true">
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="title[{{$lang}}]" class="form-control" placeholder="{{__('admin.write') . __('admin.title')}} {{ $lang }}"  >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="type" id="type" class="select2 form-control" required
                                                        ...
                                                        <option value="services">{{ __('admin.services') }}</option>
                                                        <option value="places">{{ __('admin.places') }}</option>
