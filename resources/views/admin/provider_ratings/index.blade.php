...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    {{-- addbutton="{{ route('admin.provider-ratings.create') }}"  --}}
    deletebutton="{{ route('admin.provider-ratings.deleteAll') }}" 
    :searchArray="[
        'provider_id' => [
            'input_type' => 'select' , 
            'rows'       => $providers , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/provider-ratings')])
@endsection
