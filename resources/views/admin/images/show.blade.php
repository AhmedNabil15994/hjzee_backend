                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="type" id="type" class="select2 form-control" >
                                                    ...
                                                    <option value="link"  {{ $image->type == 'link' ?'selected' :''  }}>{{__('admin.link')}}</option>
                                                    <option value="service" {{ $image->type == 'service' ?'selected' :''  }}>{{__('admin.service')}}</option>
                                                    <option value="place" {{ $image->type == 'place' ?'selected' :''  }}>{{__('admin.place')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12" id="link_section" style="{{ $image->type == 'link'?'display:block;':'display:none;' }}">
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-12" id="service_section" style="{{ $image->type == 'service'?'display:block;':'display:none;' }}">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="service_id" id="service_id" class="select2 form-control" >
                                                        ...
                                                        @foreach ($services as $service)
                                                            <option value="{{$service->id}}" {{ $image->service_id == $service->id ?'selected' :''}}>{{$service->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 col-12" id="place_section" style="{{ $image->type == 'place'?'display:block;':'display:none;' }}">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="place_id" id="place_id" class="select2 form-control" >
                                                        ...
                                                        @foreach ($places as $place)
                                                            <option value="{{$place->id}}" {{ $image->place_id == $place->id ?'selected' :''}} >{{$place->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
